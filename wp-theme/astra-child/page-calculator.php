 ...
 */
get_header(); // Astra 헤더 사용 or 생략 가능
?>
<!DOCTYPE html>
...
<div class="mi-intro-section">
  <div class="mi-intro-inner">
    ...
    <p class="mi-intro-desc">세금·부동산·대출부터 정부지원금까지, 자주 쓰는 금융 계산기를 한곳에. 찾는 항목을 검색하거나 분야에서 골라 바로 계산하세요.</p>
...
window.MI_CALC_DATA = <?php echo json_encode([
  ['id'=>'cat-budongsan','name'=>'부동산','items'=>[
    ['name'=>'취득세','desc'=>'주택·부동산 매입 시 취득세 계산','url'=>'#'],
    ['name'=>'중개수수료','desc'=>'매매·전월세 중개보수 상한 계산','url'=>'#'],
    ['name'=>'전월세 전환','desc'=>'전세↔월세 전환율로 환산','url'=>'#'],
    ['name'=>'임대수익률','desc'=>'임대 투자 연 수익률 계산','url'=>'#'],
    ['name'=>'등기비용','desc'=>'소유권 이전 등기비용 계산','url'=>'#'],
    ['name'=>'평수 환산','desc'=>'평↔제곱미터 면적 환산','url'=>'#'],
    ['name'=>'국민주택채권','desc'=>'매입 채권 본인부담금 계산','url'=>'#'],
  ]],
  ['id'=>'cat-jikjang','name'=>'직장인·4대보험','items'=>[
    ['name'=>'연봉 실수령액','desc'=>'4대보험·세금 제외 실수령액','url'=>'#'],
    ['name'=>'실업급여','desc'=>'수급 기간·일액 계산','url'=>'#'],
    ['name'=>'퇴직금','desc'=>'평균임금 기준 퇴직금 계산','url'=>'#'],
    ['name'=>'국민연금','desc'=>'예상 수령액 추정','url'=>'#'],
    ['name'=>'건강보험료','desc'=>'직장·지역·피부양자 보험료','url'=>'#'],
    ['name'=>'연장·야간수당','desc'=>'가산수당 계산','url'=>'#'],
  ]],
  ['id'=>'cat-segeum','name'=>'세금·신고','items'=>[
    ['name'=>'연말정산','desc'=>'환급·추가납부액 계산','url'=>'#'],
    ['name'=>'종합소득세','desc'=>'누진세율 기준 소득세 계산','url'=>'#'],
    ['name'=>'프리랜서 3.3%','desc'=>'원천징수 환급액 계산','url'=>'#'],
    ['name'=>'부가가치세','desc'=>'매출·매입 부가세 계산','url'=>'#'],
    ['name'=>'법인세','desc'=>'과세표준별 법인세 계산','url'=>'#'],
    ['name'=>'월세 세액공제','desc'=>'월세 세액공제액 계산','url'=>'#'],
    ['name'=>'카드 황금비율','desc'=>'소득공제 극대화 사용액','url'=>'#'],
    ['name'=>'부양가족 공제','desc'=>'인적공제 대상·금액 확인','url'=>'#'],
    ['name'=>'종합부동산세','desc'=>'종부세 과세표준·세액 계산','url'=>'#'],
    ['name'=>'증여세','desc'=>'증여재산 세액 계산','url'=>'#'],
    ['name'=>'양도소득세','desc'=>'양도차익 세액 계산','url'=>'#'],
  ]],
  ['id'=>'cat-daechul','name'=>'대출·금융','items'=>[
    ['name'=>'대출이자','desc'=>'원리금·이자 상환액 계산','url'=>'#'],
    ['name'=>'예적금 이자','desc'=>'만기 이자·세후 수령액','url'=>'#'],
    ['name'=>'중도상환수수료','desc'=>'조기상환 수수료 계산','url'=>'#'],
    ['name'=>'DSR·DTI·LTV','desc'=>'대출 한도 지표 계산','url'=>'#'],
  ]],
  ['id'=>'cat-investment','name'=>'투자·절세','items'=>[
    ['name'=>'코인 세금','desc'=>'가상자산 양도세 계산 (2027년 시행)','url'=>'#'],
    ['name'=>'ISA·IRP 절세','desc'=>'절세 혜택·환급 계산','url'=>'#'],
    ['name'=>'주식 배당세','desc'=>'배당소득세 계산','url'=>'#'],
    ['name'=>'해외주식 양도세','desc'=>'해외주식 매도 양도세 계산','url'=>'#'],
  ]],
  ['id'=>'cat-cheongnyeon','name'=>'청년·청약','items'=>[
    ['name'=>'청년도약계좌','desc'=>'만기 수령액·매칭 계산','url'=>'#'],
    ['name'=>'청약 가점','desc'=>'청약 가점 산정','url'=>'#'],
    ['name'=>'청년전세대출 이자','desc'=>'버팀목·청년 전세대출 이자 계산','url'=>'#'],
    ['name'=>'청약 당첨확률','desc'=>'가점·추첨 당첨확률 시뮬레이션','url'=>'#'],
  ]],
  ['id'=>'cat-gajok','name'=>'가족·생활','items'=>[
    ['name'=>'근로·자녀장려금','desc'=>'장려금 자격·금액 산정','url'=>'#'],
    ['name'=>'출산·부모급여','desc'=>'출산·부모급여 수령액 계산','url'=>'#'],
    ['name'=>'상속세','desc'=>'상속재산 세액 계산','url'=>'#'],
    ['name'=>'자동차세','desc'=>'배기량 기준 자동차세 계산','url'=>'#'],
    ['name'=>'최저임금','desc'=>'시급·월급 환산','url'=>'#'],
  ]],
]); ?>;
</script>
